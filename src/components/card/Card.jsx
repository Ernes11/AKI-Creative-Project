            ...
            return (
              <div className="column" key={Val.id}>
                ...
                <div className="social-icons">
                  <a target="_blank" rel="noreferrer" className="icons" href={Val.founder.submit.facebook}><FaFacebookSquare size={30}  /></a>
                  <a target="_blank" rel="noreferrer"  href={Val.founder.submit.telegram}><FaTelegram size={30} className="icons" /></a>
                  <a target="_blank" rel="noreferrer" href={Val.founder.submit.instagram}><AiFillInstagram size={32} className="icons" /></a>
                </div>
              </div>
            );
          })}
